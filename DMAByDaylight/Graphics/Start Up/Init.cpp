...
void RenderFrame()
{
	...
	DrawSkillCheck();
	if (EngineInstance)
		EngineInstance->AutoSkillCheck(Configs.SkillCheck.AutoSkillCheck, Configs.SkillCheck.AutoSkillCheckKey, Configs.SkillCheck.UseMakcu, Configs.SkillCheck.ComPort);
	Render();
