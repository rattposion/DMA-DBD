...
Vector2 Camera::WorldToScreen(MinimalViewInfo viewinfo, Vector3 world)
{
	...
	Vector3 rot = Vector3((float)viewinfo.Rotation.Pitch, (float)viewinfo.Rotation.Yaw, (float)viewinfo.Rotation.Roll);
	Vector3 campos = Vector3((float)viewinfo.Location.X, (float)viewinfo.Location.Y, (float)viewinfo.Location.Z);
